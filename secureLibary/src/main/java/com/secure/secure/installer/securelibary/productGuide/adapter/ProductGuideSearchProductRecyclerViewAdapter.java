...
public class ProductGuideSearchProductRecyclerViewAdapter extends RecyclerView.Adapter<ProductGuideSearchProductRecyclerViewAdapter.ViewHolder> {

    private List<ProductTableData> product_list;
    Context mContext;

    // data is passed into the constructor
    public ProductGuideSearchProductRecyclerViewAdapter(Context context, List<ProductTableData> product_list) {
        ...
        try {
            ...
            holder.homeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    GlobalClass.navigateToWebView(mContext);
                }
            });
