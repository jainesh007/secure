package com.secure.secure.installer.securelibary.libary;
...
public class AlphabetIndexFastScrollRecyclerSection extends RecyclerView.AdapterDataObserver {
    ...
    public AlphabetIndexFastScrollRecyclerSection(Context context, AlphabetIndexFastScrollRecyclerView rv) {
